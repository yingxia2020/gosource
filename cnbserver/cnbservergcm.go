...
-.p>8DXn,CFP#w^J4?xrx${1@W)xoww9NMwXSbQ:\:^{"{vtVZ9dcV+X/S&N\61`
	...
	MCRESULTS = `Monte Carlo European Option Pricing Double Precision

Build Time       = Dec 17 2019 09:28:51
Path Length      = 262144
Number of Options= 4096
Block Size       = 4096
Worker Threads   = 4
Opt per thread   = 1024
...
------ Top 20 results ------
 ...
 StockPrice = 49.189413    OptionStrikePrice = 10.833526    OptionYears = 4.999372    CallResult = 41.197741    CallConfidence = 0.042647
 StockPrice = 49.158805    OptionStrikePrice = 18.440313    OptionYears = 4.952910    CallResult = 35.456291    CallConfidence = 0.042506
 StockPrice = 49.161448    OptionStrikePrice = 13.603595    OptionYears = 4.937238    CallResult = 39.072424    CallConfidence = 0.042346
 StockPrice = 49.807256    OptionStrikePrice = 19.002376    OptionYears = 4.810695    CallResult = 35.558712    CallConfidence = 0.042200
 StockPrice = 48.796457    OptionStrikePrice = 20.481816    OptionYears = 4.964525    CallResult = 33.604014    CallConfidence = 0.042080
 StockPrice = 49.908107    OptionStrikePrice = 12.695308    OptionYears = 4.756010    CallResult = 40.349629    CallConfidence = 0.042045
 StockPrice = 48.588720    OptionStrikePrice = 14.504360    OptionYears = 4.980232    CallResult = 37.815904    CallConfidence = 0.041893
 StockPrice = 48.758855    OptionStrikePrice = 13.573222    OptionYears = 4.897137    CallResult = 38.645099    CallConfidence = 0.041819
 StockPrice = 48.240214    OptionStrikePrice = 13.055027    OptionYears = 4.963584    CallResult = 38.561858    CallConfidence = 0.041665
 StockPrice = 48.897169    OptionStrikePrice = 23.439346    OptionYears = 4.790699    CallResult = 31.342902    CallConfidence = 0.041605
 StockPrice = 49.309580    OptionStrikePrice = 22.520081    OptionYears = 4.740363    CallResult = 32.360383    CallConfidence = 0.041491
 StockPrice = 48.782595    OptionStrikePrice = 24.086556    OptionYears = 4.823245    CallResult = 30.746445    CallConfidence = 0.041396
 StockPrice = 48.161465    OptionStrikePrice = 21.298622    OptionYears = 4.912380    CallResult = 32.262912    CallConfidence = 0.041387
 StockPrice = 48.096318    OptionStrikePrice = 23.510886    OptionYears = 4.893287    CallResult = 30.564955    CallConfidence = 0.041237
 StockPrice = 48.493293    OptionStrikePrice = 10.728312    OptionYears = 4.763718    CallResult = 40.428679    CallConfidence = 0.041137
 StockPrice = 48.858838    OptionStrikePrice = 12.648115    OptionYears = 4.717609    CallResult = 39.326757    CallConfidence = 0.041125
 StockPrice = 48.439532    OptionStrikePrice = 18.995669    OptionYears = 4.765466    CallResult = 34.172202    CallConfidence = 0.041069
 StockPrice = 48.251293    OptionStrikePrice = 16.864900    OptionYears = 4.789773    CallResult = 35.573967    CallConfidence = 0.040918
 StockPrice = 48.749314    OptionStrikePrice = 16.692504    OptionYears = 4.685345    CallResult = 36.132055    CallConfidence = 0.040872
 StockPrice = 48.481906    OptionStrikePrice = 12.651190    OptionYears = 4.703318    CallResult = 38.928400    CallConfidence = 0.040812

----- End of 20 results -----

==========================================
Time Elapsed = 1.105010
Opt/sec      = 3706.753675
==========================================
`
...
func mcHandler(ctx *fasthttp.RequestCtx) {
	...
	startTime = time.Now()
	respMC, err := http.Get("http://mc-service.default.svc.cluster.local:8074")
	if err != nil {
	...
	err = parseMCResults(re, MCRESULTS)
	if err != nil {
