...
type SGX struct {
	...
	IsDebuggable *bool    `json:"isdebuggable,omitempty"`
	TrustScore   string   `json:"accepted_trust_score,omitempty"`
	TcbStatus    []string `json:"accepted_tcb_status,omitempty"`
}
...
Input JSON file such as:
{
	"policy": {
		...
		"sgx": {
			"isvprodid": [0, 2, 4],
			"isvsvn": ">=1",
			"mrenclave": ["bab91f200038076ac25f87de0ca67472443c2ebe17ed9ba195314e609038f51ab"],
			"mrsigner": ["d412a4f07ef83892a5915fb2ab584be31e186e5a4f95ab5f6950fd4eb8694d7b"],
			"isdebuggable": true,
			"accepted_trust_score": ">=5",
			"accepted_tcb_status": ["CONFIG_NEEDED", "SW_HARDENING_NEEDED"]
		}
	}
}
